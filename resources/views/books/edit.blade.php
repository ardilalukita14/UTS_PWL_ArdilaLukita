        ...
        <div class="card" style="width: 24rem;">
            ...
            <div class="card-body">
                ...
                <div class="form-group"> 
                    ...
                    <input type="Kategori" name="Kategori" class="form-control" id="Kategori" value="{{ $Buku->Kategori }}" 
                           aria-describedby="Kategori" >                 
                </div> 
                <div class="form-group"> 
                    <label for="Penerbit">Penerbit</label>                     
                    <input type="Penerbit" name="Penerbit" class="form-control" id="Penerbit" value="{{ $Buku->Penerbit }}" 
                ...
                <div class="form-group"> 
                    ...
                    <input type="Jumlah" name="Jumlah" class="form-control" id="Jumlah" value="{{ $Buku->Jumlah }}" 
